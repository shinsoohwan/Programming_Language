...
public class TypeTransformer {
    ...
    public static Expression T (Expression e, TypeMap tm) {
        ...
        if (e instanceof Unary) {
            ...
            if ((type == Type.BOOL) && (u.op.NotOp())) return new Unary(u.op.boolMap(u.op.val), t0);
            else if ((type == Type.FLOAT) && (u.op.NegateOp())) return new Unary(u.op.floatMap(u.op.val), t0);
            else if ((type == Type.INT) && (u.op.NegateOp())) return new Unary(u.op.intMap(u.op.val), t0);
