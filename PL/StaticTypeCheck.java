...
public class StaticTypeCheck {
	...
	public static void V(Statement s, TypeMap tm) {
		...
		else if (s instanceof Assignment)
		{
			...
			if (ttype != srctype)
			{
				if (ttype == Type.FLOAT) check(srctype == Type.INT, "mixed mode assignment to " + a.target);
				else if (ttype == Type.INT) check(srctype == Type.CHAR, "mixed mode assignment to " + a.target);
		...
		else if (s instanceof Conditional)
		{
			...
			else check(false, "poorly typed if in Conditional: " + c.test);
		} 
		else if (s instanceof Loop)
		{
			...
			if (testtype == Type.BOOL) V(l.body, tm); 
			else check(false, "poorly typed test in while Loop in Conditional: " + l.test);
		} 
		else if (s instanceof Block)
		{
			Block b = (Block) s;
			for (Statement i : b.members) V(i, tm);
	...
	public static void main(String args[]) {
		Parser parser=new Parser(new Lexer("C:/Users/user/Desktop/Parser/inputdata.txt"));
